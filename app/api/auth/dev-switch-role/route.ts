...
export async function POST(request: NextRequest) {
  try {
    ...
    // SECURITY FIX: Only allow ADMIN or SUPER_ADMIN to switch roles, EXCEPT for demo users
    if (decoded.userId !== 'demo-1' && decoded.role !== 'ADMIN' && decoded.role !== 'SUPER_ADMIN') {
